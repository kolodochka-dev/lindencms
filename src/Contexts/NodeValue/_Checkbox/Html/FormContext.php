...
namespace LindenCMS\Cms\Contexts\NodeValue\_Checkbox\Html;

use LindenCMS\Cms\Ui\Forms\Inputs\Checkbox;
use LindenCMS\Cms\Contexts\HtmlContext;
use LindenCMS\Core\Node;
use LindenCMS\Cms\Nodes\_Checkbox;
...
class FormContext extends HtmlContext
{
    ...
    public function __invoke(): mixed
    {
        return (string) new Checkbox(
            ...
            option: $this->getData('option', $this->node->_view()?->option),
            id: $this->node->getUid(),
